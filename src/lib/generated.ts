...
export const SENSOR_FORMATS = [
  ...
  },
  {
    ...
    crop_factor: "1.00",
    description:
      "Catch-all for various larger than full-frame wide and large format cinema camera sensors",
...
export const ENUMS = {
  ...
  badge_award_source: ["auto", "manual"],
  ...
  camera_type_enum: ["dslr", "mirrorless", "slr", "action", "cinema"],
  card_bus_enum: [
    "sd_default",
    "uhs_i",
    "uhs_ii",
  ...
  date_precision_enum: ["YEAR", "MONTH", "DAY"],
  exposure_modes_enum: [
    "manual",
    "aperture-priority",
    "shutter-priority",
  ...
  gear_region: ["GLOBAL", "EU", "JP"],
  gear_type: ["CAMERA", "ANALOG_CAMERA", "LENS"],
  ...
  metering_mode_enum: ["average", "center-weighted", "spot", "other"],
  mount_material_enum: ["metal", "plastic"],
  notification_type: [
    "gear_spec_approved",
    "badge_awarded",
    "prompt_handle_setup",
  ...
  popularity_timeframe: ["7d", "30d"],
  proposal_status: ["PENDING", "APPROVED", "REJECTED", "MERGED"],
  raw_bit_depth_enum: ["10", "12", "14", "16"],
  ...
  rec_group: ["prime", "zoom"],
  rec_rating: ["best value", "best performance", "situational", "balanced"],
  ...
  sensor_tech_types_enum: ["cmos", "ccd"],
  shutter_type_enum: [
    "focal-plane-cloth",
    "focal-plane-metal",
  ...
  shutter_types_enum: ["mechanical", "efc", "electronic"],
  user_role: ["USER", "MODERATOR", "EDITOR", "ADMIN", "SUPERADMIN"],
  viewfinder_types_enum: ["none", "optical", "electronic"],
} as const;

export type EnumValues<TName extends keyof typeof ENUMS> =
  (typeof ENUMS)[TName][number];
