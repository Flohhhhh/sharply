...
import { Bird, Home, Library, Loader } from "lucide-react";
  ...
  try {
    ...
    return (
      <main className="mx-auto min-h-screen max-w-7xl space-y-10 px-4 pt-36 pb-12 sm:px-6">
        {/* Hero search mirrors the home page layout */}
        <section className="mx-auto max-w-4xl space-y-4 text-center">
          <h1 className="text-4xl font-bold tracking-tight md:text-5xl">
            Search the Sharply catalog
          </h1>
          <Suspense
            fallback={
              <div className="relative">
                <div className="text-muted-foreground flex h-16 items-center rounded-xl border pr-14 pl-10 text-base">
                  Loading search…
          ...
          <p className="text-muted-foreground text-sm sm:text-base">
            {q
              ? `Refine your search for “${q}” or try a new term.`
              : "Find gear, specs, and reviews across the full catalog."}
          </p>
        </section>
