...
- `src/app/api/out/bh/route.ts` re-validates the URL via `parseBhProductUrl` (allowed hosts: `bhphotovideo.com`, `www.bhphotovideo.com`, `bhpho.to`), logs `bhphoto_redirect`, and returns a 307 redirect.
