...
describe("gear detail heading translations", () => {
  it("keeps gear detail edit and review labels localized for every shipped locale", () => {
    ...
    const requiredPaths = [
      ...
      "instructionManual.navLabel",
      "instructionManual.description",
      "instructionManual.openCta",
      "instructionManual.modalTitle",
      "instructionManual.modalDescription",
      "instructionManual.fieldLabel",
      "instructionManual.guidanceTitle",
      "instructionManual.guidanceOfficialFiles",
      "instructionManual.guidanceDirectUrls",
      "instructionManual.guidanceAvoidMirrors",
      "instructionManual.guidanceExactModelRegion",
      "instructionManual.save",
      "instructionManual.remove",
      "instructionManual.saved",
      "instructionManual.removed",
